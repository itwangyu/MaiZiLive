package com.maizi.maizilive.utils;
...
public class AppInfoUtil {
	...
	public static PackageInfo getApkInfo(Context context, String archiveFilePath) {
		...
		PackageInfo apkInfo = pm.getPackageArchiveInfo(archiveFilePath, PackageManager.GET_ACTIVITIES);
		return apkInfo;
	}
...
//		String channel = "";
////		try {
////			channel = context.getPackageManager().getApplicationInfo(context.getPackageName(), PackageManager.GET_META_DATA).metaData.getInt("UMENG_CHANNEL")+"";
////		} catch (NameNotFoundException e) {
////			e.printStackTrace();
////		}
//		try {
//			channel = WalleChannelReader.getChannelInfo(context).getChannel();
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		return channel;
